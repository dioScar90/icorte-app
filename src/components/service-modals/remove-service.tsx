...
// type Props = {
//   remove: BarberShopServicesLayoutContextType['remove']
//   closeModal: () => void
//   barberShopId: number
//   serviceId: number
// }

// export function RemoveServiceModal({ remove, closeModal, barberShopId, serviceId }: Props) {
...
//     try {
//       const result = await remove(barberShopId, serviceId)
